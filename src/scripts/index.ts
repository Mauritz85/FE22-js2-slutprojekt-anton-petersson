...
import { addEntryToFirebase, getStatusUpdates, entries, userImg, userValidated, getUserImg, userValidation, userAdded, addUserToFirebase, getMembers, members } from "../modules/firebase";
...
async function showHomeTemplate() {
    ...
    if (typeof localUser === "string" && typeof localImg === "string") {
        ...
        if (userImg == 'flower') {
            imgUrl = new URL('../images/flower.jpg', import.meta.url);
        }
        if (userImg == 'duck') {
            imgUrl = new URL('../images/duck.jpg', import.meta.url);
        }
        if (userImg == 'lemon') {
            imgUrl = new URL('../images/lemon.jpg', import.meta.url);
        }


        profileImg.src = imgUrl.href
